...
# Quindi qui NON chiediamo nulla — i gateway possono essere zero al boot.
declare -A GW_PASSWORDS  # mantenuto vuoto per compatibilità con gli step seguenti
...
if [[ ${#GW_PASSWORDS[@]} -gt 0 ]]; then
    : # nessun gateway gestito qui
fi
